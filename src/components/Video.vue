...
// import { getRandomInt } from '../assets/randomInt'
import { onBeforeUnmount, ref } from 'vue'
import { onMounted } from "vue";
import axios from 'axios'
// import { ElAside, ElButton, ElContainer, ElMain, ElMessage, ElTree, ElTooltip, TreeNode } from 'element-plus';
...
// //高亮处理函数
// function handleHeightLight(target: Event) {
...
<template>
    <div class="container">
        <div class="video-container">
            ...
            <video v-bind:src=videoData.src v-on:ended="videoEnd(1)" v-on:pause="lastVideo('pause')" controls autoplay
                ref="vi"></video>
        </div>
        <!-- :props="defaultProps" -->
        <div class="video-list">
            <el-tree :data="videoData.mydata" v-bind:render-after-expand=true v-bind:props="defaultProps"
